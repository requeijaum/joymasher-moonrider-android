...
(function () {
    ...
    function segRow(label, sub, choices, getVal, setVal) {
        ...
        function refresh() { btns.forEach(function (x) { x.el.classList.toggle("on", x.value === getVal()); }); }
        refresh();
